...
class CommunityRoles {
	...
	public static function get_role( int $user_id ): string {
		...
		if ( ! in_array( $role, array( self::PUBLIC_USER, self::VERIFIED_ARTIST, self::MODERATOR, self::ADMINISTRATOR ), true ) ) {
			return self::PUBLIC_USER;
		}
		return $role;
	}
	...
	public static function can_post_thread( int $user_id ): bool {
		return self::has_role( $user_id, array( self::VERIFIED_ARTIST, self::MODERATOR, self::ADMINISTRATOR ) );
	}
	...
	public static function can_moderate( int $user_id ): bool {
		return self::has_role( $user_id, array( self::MODERATOR, self::ADMINISTRATOR ) );
	}
	...
	public static function register(): void {
		add_action( 'user_register', array( self::class, 'assign_default_role' ) );
	}
}
