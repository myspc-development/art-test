...
class ProfileLinkRequestAdmin {
	...
	public static function register(): void {
		add_action( 'admin_menu', array( self::class, 'add_link_request_menu' ) );
		add_filter( 'manage_edit-ap_profile_link_req_columns', array( self::class, 'custom_columns' ) );
		add_action( 'manage_ap_profile_link_req_posts_custom_column', array( self::class, 'render_custom_columns' ), 10, 2 );
	}
