...
class MetaBoxesAddress {
	...
	public static function register( $post_types ) {
		...
		foreach ( $post_types as $post_type ) {
			...
			add_action(
				...
				function ( $post ) use ( $post_type, $prefix ) {
					add_meta_box(
			...
			add_action(
				...
				function ( $post_id, $post ) use ( $post_type, $prefix ) {
	 ...
	 */
	public static function save_address_meta( $post_id, $post, string $prefix = '' ) {
		// $post parameter is available
