...
class PostStatusRejected {
	...
	public static function register() {
		...
		add_filter( 'display_post_states', array( self::class, 'state_label' ) );
		add_action( 'admin_footer-post.php', array( self::class, 'inject_dropdown' ) );
		add_action( 'admin_footer-post-new.php', array( self::class, 'inject_dropdown' ) );
	}
