...
class EventNotesTasks
{
    public static function register(): void
    {
        ...
        add_action('save_post_artpulse_event', [self::class, 'handle_save'], 10, 2);
    ...
    {
        add_meta_box('ap_event_notes', __('Internal Notes', 'artpulse'), [self::class, 'render_notes_box'], 'artpulse_event');
        add_meta_box('ap_event_tasks', __('Tasks', 'artpulse'), [self::class, 'render_tasks_box'], 'artpulse_event');
    }
