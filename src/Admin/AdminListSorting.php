...
class AdminListSorting {
	public static function register() {
		add_action( 'pre_get_posts', array( self::class, 'sort_admin_columns' ) );

		// Make columns sortable
		add_filter(
			'manage_edit-artpulse_artist_sortable_columns',
			function ( $columns ) {
		...
		add_filter(
			'manage_edit-artpulse_artwork_sortable_columns',
			function ( $columns ) {
		...
		add_filter(
			'manage_edit-artpulse_event_sortable_columns',
			function ( $columns ) {
		...
		add_filter(
			'manage_edit-artpulse_org_sortable_columns',
			function ( $columns ) {
