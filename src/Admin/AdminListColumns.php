...
class AdminListColumns {
	...
	public static function register() {
		add_filter( 'manage_artpulse_artist_posts_columns', array( self::class, 'artist_columns' ) );
		add_action( 'manage_artpulse_artist_posts_custom_column', array( self::class, 'render_artist_columns' ), 10, 2 );

		add_filter( 'manage_artpulse_artwork_posts_columns', array( self::class, 'artwork_columns' ) );
		add_action( 'manage_artpulse_artwork_posts_custom_column', array( self::class, 'render_artwork_columns' ), 10, 2 );

		add_filter( 'manage_artpulse_event_posts_columns', array( self::class, 'event_columns' ) );
