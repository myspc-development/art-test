...
class ShortcodePages {
	...
	private static function get_page_ids(): array {
		return array_map( 'intval', (array) get_option( 'ap_shortcode_page_ids', array() ) );
	}
	...
	public static function create_pages( array $selected = array() ): void {
	...
	public static function render(): void {
		...
		if ( isset( $_POST['ap_create_shortcode_pages'] ) && check_admin_referer( 'ap_create_shortcode_pages' ) ) {
			$selected = array_map( 'sanitize_text_field', $_POST['ap_shortcodes'] ?? array() );
		...
		<div class="wrap">
			...
			<form method="post">
				...
				<fieldset id="ap-shortcode-list">
					...
					<?php
					foreach ( self::get_shortcode_map() as $code => $label ) :
