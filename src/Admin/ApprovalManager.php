...
class ApprovalManager {
	...
	public static function register() {
		...
		add_action( 'add_meta_boxes', array( __CLASS__, 'addApprovalMetabox' ) );
		// Handle approval and rejection actions
		add_action( 'admin_post_ap_approve_submission', array( __CLASS__, 'handleApproval' ) );
		add_action( 'admin_post_ap_reject_submission', array( __CLASS__, 'handleRejection' ) );
	}
	...
	public static function handleApproval() {
		...
		if ( $post && in_array( $post->post_type, array( 'ap_artist_request', 'artpulse_artist' ), true ) ) {
