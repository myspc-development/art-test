...
class AdminColumnsTaxonomies {
	...
	public static function register() {
		// Artist specialties
		add_filter( 'manage_edit-artpulse_artist_columns', array( self::class, 'artist_columns' ) );
		add_filter( 'manage_edit-artpulse_artist_sortable_columns', array( self::class, 'artist_sortable_columns' ) );

		// Artwork styles
		add_filter( 'manage_edit-artpulse_artwork_columns', array( self::class, 'artwork_columns' ) );
		add_filter( 'manage_edit-artpulse_artwork_sortable_columns', array( self::class, 'artwork_sortable_columns' ) );

		// Event types
		add_filter( 'manage_edit-artpulse_event_columns', array( self::class, 'event_columns' ) );
		add_filter( 'manage_edit-artpulse_event_sortable_columns', array( self::class, 'event_sortable_columns' ) );

		// Organization categories
		add_filter( 'manage_edit-artpulse_org_columns', array( self::class, 'org_columns' ) );
		add_filter( 'manage_edit-artpulse_org_sortable_columns', array( self::class, 'org_sortable_columns' ) );

		// Render taxonomy columns
		add_action( 'manage_artpulse_artist_posts_custom_column', array( self::class, 'render_artist_columns' ), 10, 2 );
		add_action( 'manage_artpulse_artwork_posts_custom_column', array( self::class, 'render_artwork_columns' ), 10, 2 );
		add_action( 'manage_artpulse_event_posts_custom_column', array( self::class, 'render_event_columns' ), 10, 2 );
		add_action( 'manage_artpulse_org_posts_custom_column', array( self::class, 'render_org_columns' ), 10, 2 );

		// Sort query modification
		add_action( 'pre_get_posts', array( self::class, 'taxonomy_sort_order' ) );
	}
