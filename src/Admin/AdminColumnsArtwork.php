...
class AdminColumnsArtwork {
	...
	public static function register() {
		add_filter( 'manage_artpulse_artwork_posts_columns', array( __CLASS__, 'add_columns' ) );
		add_action( 'manage_artpulse_artwork_posts_custom_column', array( __CLASS__, 'render_columns' ), 10, 2 );
		add_filter( 'manage_edit-artpulse_artwork_sortable_columns', array( __CLASS__, 'make_sortable' ) );
	}
