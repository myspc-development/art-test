...
class FeedbackManager {
	...
	public static function register(): void {
		...
		add_action( 'wp_ajax_ap_submit_feedback', array( self::class, 'handle_submission' ) );
		add_action( 'wp_ajax_nopriv_ap_submit_feedback', array( self::class, 'handle_submission' ) );
	}
	...
	public static function handle_submission(): void {
		...
		if ( empty( $description ) ) {
			wp_send_json_error( array( 'message' => __( 'Description required.', 'artpulse' ) ) );
		}
