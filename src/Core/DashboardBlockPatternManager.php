...
class DashboardBlockPatternManager {
    public static function register(): void {
        add_action('init', [self::class, 'register_patterns']);
    }
    ...
    public static function register_patterns(): void {
        ...
        register_block_pattern_category('artpulse-dashboards', [
            'label' => __('Dashboards', 'artpulse'),
        ]);

        $patterns = get_option('ap_dashboard_widget_config', []);
        ...
        foreach ($patterns as $role => $markup) {
            ...
            register_block_pattern(
                ...
                [
                    ...
                    'categories' => ['artpulse-dashboards'],
                    'content'    => $markup,
                ]
            );
        }
