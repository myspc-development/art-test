...
class MetaBoxRegistrar {
	...
	public static function register() {
		...
		add_action( 'add_meta_boxes_artpulse_event', array( self::class, 'add_meta_boxes' ) );
		...
		add_action( 'save_post_artpulse_event', array( self::class, 'save_meta' ), 10, 2 );
	}
	...
	public static function add_meta_boxes( $post ) {
		add_meta_box(
			...
			array( self::class, 'render_event_meta_box' ), // Callback function to render the meta box HTML
