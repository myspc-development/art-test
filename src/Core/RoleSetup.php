    ...
    private static function assign_capabilities(): void
    {
        ...
        $roles_caps = [
            ...
            'artist' => [
                ...
                'delete_artpulse_artworks', 'delete_private_artpulse_artworks',
                'delete_published_artpulse_artworks', 'delete_others_artpulse_artworks',
                'edit_private_artpulse_artworks', 'edit_published_artpulse_artworks',
            ...
            'organization' => [
                ...
                'delete_artpulse_events', 'delete_private_artpulse_events',
                'delete_published_artpulse_events', 'delete_others_artpulse_events',
                'edit_private_artpulse_events', 'edit_published_artpulse_events',
