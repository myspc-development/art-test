...
class SubmissionForms {
	...
	public static function register(): void {
		\ArtPulse\Core\ShortcodeRegistry::register( 'ap_submission_form', 'Submission Form', array( __CLASS__, 'render_form' ) );
	...
	public static function render_form( array $atts ): string {
		...
		<form class="ap-form-container" data-post-type="<?php echo $post_type; ?>">
			...
			<p>
				...
				<input class="ap-input" id="ap-date" type="date" name="event_date" data-required="<?php esc_attr_e( 'Date is required', 'artpulse' ); ?>" />
			</p>
			<p>
				<label class="ap-form-label" for="ap-start-date"><?php esc_html_e( 'Start Date*', 'artpulse' ); ?></label><br>
				<input class="ap-input" id="ap-start-date" type="date" name="event_start_date" data-required="<?php esc_attr_e( 'Start date is required', 'artpulse' ); ?>" />
			</p>
			<p>
				<label class="ap-form-label" for="ap-end-date"><?php esc_html_e( 'End Date', 'artpulse' ); ?></label><br>
				<input class="ap-input" id="ap-end-date" type="date" name="event_end_date" />
			</p>
			<p>
				<label class="ap-form-label" for="ap-venue-name"><?php esc_html_e( 'Venue Name', 'artpulse' ); ?></label><br>
				<input class="ap-input" id="ap-venue-name" type="text" name="venue_name" />
			</p>
			<p>
				<label class="ap-form-label" for="ap-street"><?php esc_html_e( 'Street Address', 'artpulse' ); ?></label><br>
				<input class="ap-input" id="ap-street" type="text" name="event_street_address" class="ap-address-street ap-address-input" />
			</p>
			<p>
				<label class="ap-form-label" for="ap-country"><?php esc_html_e( 'Country*', 'artpulse' ); ?></label><br>
				<input class="ap-input" id="ap-country" type="text" name="event_country" class="ap-address-country ap-address-input" data-required="<?php esc_attr_e( 'Country is required', 'artpulse' ); ?>" />
			</p>
			<p>
				<label class="ap-form-label" for="ap-state"><?php esc_html_e( 'State/Province', 'artpulse' ); ?></label><br>
				<input class="ap-input" id="ap-state" type="text" name="event_state" class="ap-address-state ap-address-input" />
			</p>
			<p>
				<label class="ap-form-label" for="ap-city"><?php esc_html_e( 'City', 'artpulse' ); ?></label><br>
				<input class="ap-input" id="ap-city" type="text" name="event_city" class="ap-address-city ap-address-input" />
			</p>
			<p>
				<label class="ap-form-label" for="ap-postcode"><?php esc_html_e( 'Postcode', 'artpulse' ); ?></label><br>
				<input class="ap-input" id="ap-postcode" type="text" name="event_postcode" class="ap-address-postcode ap-address-input" />
			</p>
			...
			<p>
				...
				<input class="ap-input" id="ap-organizer-email" type="email" name="event_organizer_email" />
			</p>
			<p>
				<label class="ap-form-label" for="ap-banner"><?php esc_html_e( 'Event Banner', 'artpulse' ); ?></label><br>
				<input class="ap-input" id="ap-banner" type="file" accept="image/*" />
			</p>
			<p>
				<label>
					<input class="ap-input" id="ap-featured" type="checkbox" name="event_featured" value="1" />
