...
class ProfileEditShortcode {
	...
	public static function register() {
		\ArtPulse\Core\ShortcodeRegistry::register( 'ap_profile_edit', 'Edit Profile', array( self::class, 'render_form' ) );
		add_action( 'wp_enqueue_scripts', array( self::class, 'enqueue_styles' ) );
		self::handle_form_submission();
		add_action( 'wp_ajax_update_profile_field', array( self::class, 'ajax_update_profile' ) );
	}
	...
	public static function render_form() {
		...
		<form method="post" enctype="multipart/form-data" class="ap-profile-edit-form ap-form-container" data-no-ajax="true">
			...
			<input type="hidden" name="address_components" id="ap-profile-address-components" value="
			<?php
			echo esc_attr(
				json_encode(
					array(
