...
class OrganizationEventForm {
	...
	public static function register() {
		...
		\ArtPulse\Core\ShortcodeRegistry::register( 'ap_org_event_form', 'Organization Event Form', array( self::class, 'render' ) );
	...
	public static function render() {
		...
		<form method="post" enctype="multipart/form-data" class="ap-form-container" data-no-ajax="true">
			...
			<input class="ap-input" id="ap_org_event_rsvp_limit" type="number" name="event_rsvp_limit" value="<?php echo esc_attr( $limit_default ); ?>"
			<?php
			if ( $limit_min ) {
				echo ' min="' . esc_attr( $limit_min ) . '"';}
			?>
			<?php
			if ( $limit_max ) {
				echo ' max="' . esc_attr( $limit_max ) . '"';}
			?>
>
	...
	public static function handle_submission() {
		...
		if ( $type ) {
			wp_set_post_terms( $post_id, array( $type ), 'event_type' );
		}
