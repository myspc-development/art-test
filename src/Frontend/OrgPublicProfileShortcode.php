...
class OrgPublicProfileShortcode {
	public static function register() {
		\ArtPulse\Core\ShortcodeRegistry::register( 'ap_org_profile', 'Organization Profile', array( self::class, 'render' ) );
	...
	public static function render( $atts = array() ) {
		...
		<div class="ap-org-profile">
			...
			if ( $tagline ) :
				?>
				<h2 class="ap-card__title"><?php echo esc_html( $tagline ); ?></h2><?php endif; ?>
			<?php
			if ( $about ) :
				?>
				<div class="ap-org-about"><?php echo wpautop( esc_html( $about ) ); ?></div><?php endif; ?>
			<?php if ( $social ) : ?>
