...
class ArtworkCommentsShortcode {
	...
	public static function register(): void {
		\ArtPulse\Core\ShortcodeRegistry::register( 'ap_artwork_comments', 'Artwork Comments', array( self::class, 'render' ) );
	...
	public static function render( $atts = array() ): string {
		...
		ob_start();
		?>
		<div class="ap-artwork-comments" data-artwork-id="<?php echo esc_attr( $artwork_id ); ?>">
