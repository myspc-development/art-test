...
class WidgetsController {
	...
	public static function register_routes(): void {
		register_rest_route(
			...
			array(
				'methods'             => 'GET',
				'callback'            => array( self::class, 'embed' ),
	...
	public static function render( WP_REST_Request $request ): WP_REST_Response {
		...
		$layout  = in_array( $request->get_param( 'layout' ), array( 'cards', 'grid', 'list' ), true ) ? $request->get_param( 'layout' ) : 'list';
		...
		return new WP_REST_Response( $html, 200, array( 'Cache-Control' => 'public,max-age=3600' ) );
	}
}
