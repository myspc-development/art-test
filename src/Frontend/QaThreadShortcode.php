...
class QaThreadShortcode {
	public static function register(): void {
		\ArtPulse\Core\ShortcodeRegistry::register( 'ap_event_qa', 'Event QA', array( self::class, 'render' ) );
	...
	public static function render( $atts ): string {
		$atts     = shortcode_atts( array( 'id' => get_the_ID() ), $atts, 'ap_event_qa' );
		...
		ob_start();
		?>
		<div class="ap-qa-thread" data-event-id="<?php echo esc_attr( $event_id ); ?>" data-can-post="<?php echo $can_post ? '1' : '0'; ?>">
