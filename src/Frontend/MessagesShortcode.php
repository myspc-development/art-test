...
class MessagesShortcode {
	...
	public static function register(): void {
		\ArtPulse\Core\ShortcodeRegistry::register( 'ap_messages', 'Messages Inbox', array( self::class, 'render' ) );
		\ArtPulse\Core\ShortcodeRegistry::register( 'ap_inbox', 'Messages Inbox', array( self::class, 'render' ) );
		\ArtPulse\Core\ShortcodeRegistry::register( 'ap_message_form', 'Message Form', array( self::class, 'render_form' ) );
