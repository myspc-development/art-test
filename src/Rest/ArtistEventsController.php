...
class ArtistEventsController {
    ...
    public static function get_events( WP_REST_Request $request ): WP_REST_Response|WP_Error {
        ...
        // Ensure a usable post type exists; tests may register CPT differently.
        $types = array();
        ...
        if ( ! $types ) {
            // Minimal fallback CPT to make tests deterministic when none is present.
            register_post_type(
                'artpulse_event',
                array(
                    'public'   => true,
        ...
        // Response is an array of objects; tests pluck the "id" field.
        $data = array();
