...
<div class="container-wrap">
	...
	<div class="row">
		...
		<?php
			...
			$event_type_terms = wp_get_post_terms( get_the_ID(), 'event_type', array( 'fields' => 'names' ) );
		...
		?>
			...
			<li><strong><?php esc_html_e( 'Organizer Email:', 'artpulse' ); ?></strong> <?php echo $org_email ? \ArtPulse\Util\ap_obfuscate_email( $org_email ) : esc_html__( 'Not specified', 'artpulse' ); ?></li>
