      ...
      <div class="col span_12">
        ...
        ?>
          ...
          <ul class="event-meta styled-box" itemscope itemtype="https://schema.org/Event">
            ...
            <li><strong><?php esc_html_e('Organizer Email:', 'artpulse'); ?></strong> <?php echo $org_email ? str_replace( '&#064;', '&#64;', esc_html( antispambot( $org_email ) ) ) : esc_html__( 'Not specified', 'artpulse' ); ?></li>
