...
<div class="ap-event-card" id="post-<?php echo esc_attr( $event_id ); ?>">
    ...
    <div class="ap-event-info">
        ...
        <?php if ( $org_name || $org_email ) : ?>
            <span class="screen-reader-text"><?php esc_html_e( 'Organizer:', 'artpulse' ); ?> <?php echo esc_html( $org_name ); ?><?php if ( $org_email ) : ?> (<?php echo str_replace( '&#064;', '&#64;', esc_html( antispambot( $org_email ) ) ); ?>)<?php endif; ?></span>
        <?php endif; ?>
        <?php
