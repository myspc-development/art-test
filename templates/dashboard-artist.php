...
<div class="dashboard-wrapper">
    ...
    <div id="ap-layout-controls">
        ...
        <fieldset id="ap-widget-toggles">
            ...
            <label><input type="checkbox" value="rsvps" title="Toggle Widget" aria-label="Toggle Widget" <?php checked($visibility['rsvps'] ?? true); ?>> <?php esc_html_e('RSVPs', 'artpulse'); ?></label>
            <label><input type="checkbox" value="my-events" title="Toggle Widget" aria-label="Toggle Widget" <?php checked($visibility['my-events'] ?? true); ?>> <?php esc_html_e('My Events', 'artpulse'); ?></label>
