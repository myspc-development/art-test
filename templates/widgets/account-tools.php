 ...
 */
?>
<section id="account-tools" class="ap-dashboard-section dashboard-card" data-widget="account-tools" <?php echo $visible ? '' : 'style="display:none"'; ?>>
    <h2><?php esc_html_e('Account Tools','artpulse'); ?></h2>
