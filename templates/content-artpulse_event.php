...
<div class="container-wrap">
	...
	<div class="row">
		...
		<?php if ( $date || $venue || $address || $start || $end || $contact || $rsvp || $organizer || $email || $city || $state || $country ) : ?>
			...
			<?php if ( $date ) : ?>
				<li><strong><?php esc_html_e( 'Date:', 'artpulse' ); ?></strong> <?php echo esc_html( $date ); ?></li>
			<?php endif; ?>
			<?php if ( $venue ) : ?>
				<li><strong><?php esc_html_e( 'Venue:', 'artpulse' ); ?></strong> <?php echo esc_html( $venue ); ?></li>
			<?php endif; ?>
			<?php if ( $address ) : ?>
			...
			<?php endif; ?>
			<?php if ( $organizer ) : ?>
				<li><strong><?php esc_html_e( 'Organizer:', 'artpulse' ); ?></strong> <?php echo esc_html( $organizer ); ?></li>
			<?php endif; ?>
			<?php if ( $email ) : ?>
				<li><strong><?php esc_html_e( 'Email:', 'artpulse' ); ?></strong> <?php echo \ArtPulse\Util\ap_obfuscate_email( $email ); ?></li>
			<?php endif; ?>
			<?php if ( $contact ) : ?>
				<li><strong><?php esc_html_e( 'Contact:', 'artpulse' ); ?></strong> <?php echo esc_html( $contact ); ?></li>
			<?php endif; ?>
			<?php if ( $rsvp ) : ?>
				<li><strong><?php esc_html_e( 'RSVP:', 'artpulse' ); ?></strong> <a href="<?php echo esc_url( $rsvp ); ?>" target="_blank"><?php esc_html_e( 'Reserve Now', 'artpulse' ); ?></a></li>
			<?php endif; ?>
			<?php if ( $city || $state || $country ) : ?>
				<li><strong><?php esc_html_e( 'Location:', 'artpulse' ); ?></strong>
				<?php echo esc_html( trim( "{$city}, {$state}, {$country}", ', ' ) ); ?>
				</li>
			<?php endif; ?>
			</ul>
		<?php endif; ?>
