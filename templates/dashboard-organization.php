...
?>
<div class="ap-dashboard-wrap <?= esc_attr($user_role) ?>-dashboard ap-role-layout" data-role="organization">
<?php
...
?>
  ...
  <div class="ap-quickstart-wrapper">
    <?php
    ap_safe_include('templates/partials/quickstart-admin-guide.php', plugin_dir_path(__FILE__) . 'partials/quickstart-admin-guide.php');
    ?>
  </div>
</div>
