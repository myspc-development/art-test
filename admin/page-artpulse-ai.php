...
function artpulse_ai_register_settings(): void {
    register_setting('artpulse_ai_settings', 'openai_api_key', [
        'sanitize_callback' => 'sanitize_text_field',
    ]);
    register_setting('artpulse_ai_settings', 'artpulse_tag_prompt', [
        'sanitize_callback' => 'sanitize_textarea_field',
    ]);
    register_setting('artpulse_ai_settings', 'artpulse_summary_prompt', [
        'sanitize_callback' => 'sanitize_textarea_field',
    ]);
...
function artpulse_ai_enqueue_scripts(string $hook): void {
    ...
    wp_localize_script('artpulse-ai-admin', 'ArtPulseAI', [
