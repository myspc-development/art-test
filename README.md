...
- **Roles & Permissions** – Manage organization roles and capabilities. Access the screen via `admin.php?page=ap-org-roles` from the Organization Dashboard menu.
- **Diagnostics** – Verify database tables and REST routes. Visit `admin.php?page=ap-diagnostics` under the ArtPulse menu.
