...
final class DashboardPreviewTest extends TestCase {
	...
	public function test_builder_preview_renders_exact_ids_in_order() {
		...
		$this->assertStringContainsString( 'data-widget-id="widget_news_feed"', $html );
		$this->assertMatchesRegularExpression(
			'#widget_news_feed.*widget_my_rsvps.*widget_nearby_events_map#s',
			$html
		);
	}
