...
class PaymentAnalyticsDashboardTest extends TestCase
{
    ...
    public function test_metrics_calculation_with_woo_and_stripe(): void
    {
        ...
        Stub::$subs = [
            ...
            (object)[ 'created' => strtotime('2024-02-20'), 'status' => 'canceled' ],
            (object)[ 'created' => strtotime('2024-03-01'), 'status' => 'active' ],
            (object)[ 'created' => strtotime('2024-03-10'), 'status' => 'active' ],
        ];
        ...
        $expected = [
            ...
            'revenue_trend'               => [40.0, 25.0, 75.0],
            'subscription_trend'          => [0, 2, 2],
        ];
