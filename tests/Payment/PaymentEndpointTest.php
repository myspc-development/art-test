...
class PaymentEndpointTest extends \WP_UnitTestCase
{
    ...
    {
        when('ArtPulse\\Payment\\StripeHelper::create_intent')->justReturn((object)['client_secret' => 'pi_secret_123']);
    ...
    {
        when('ArtPulse\\Payment\\StripeHelper::create_session')->justReturn((object)['id' => 'sess_999']);
