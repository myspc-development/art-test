...
namespace ArtPulse\Core {
    ...
    if (!function_exists(__NAMESPACE__ . '\get_post')) {
        function get_post($id) { return (object)['ID' => $id, 'post_title' => 'Post ' . $id]; }
    }
    if (!function_exists(__NAMESPACE__ . '\get_userdata')) {
        function get_userdata($uid) { return (object)['ID' => $uid, 'roles' => \ArtPulse\Core\Tests\Stub::$roles]; }
    }
...
namespace ArtPulse\Core\Tests {
    ...
    final class UserDashboardManagerTest extends TestCase
    {
