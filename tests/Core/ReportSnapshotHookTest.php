...
class SnapshotBuilder {
    ...
    public static function generate_csv(array $args): string { self::$called = 'csv'; return __FILE__ . '.csv'; }
    public static function generate_pdf(array $args): string { self::$called = 'pdf'; return __FILE__ . '.pdf'; }
}
class GrantReportBuilder {
    public static bool $called = false;
    public static function generate_pdf(array $args): string { self::$called = true; return __FILE__ . '.grant.pdf'; }
}
