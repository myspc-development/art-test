...
class Stub {
	...
	public static array $charges           = array();
	public static array $subs              = array();
...
class WC_Order {
	...
	public function get_date_created(): OrderDate {
		return new OrderDate( $this->ts ); }
...
class Charges {
	public function all( array $params = array() ) {
		...
		return (object) array( 'data' => Stub::$charges );
	}
}
...
class Subscriptions {
	public function all( array $params = array() ) {
		...
		return (object) array( 'data' => Stub::$subs );
	}
}
...
class PaymentIntents {
	public function create( array $params = array() ) {
		return (object) array( 'client_secret' => 'pi_secret' );
	}
}
...
if ( ! function_exists( __NAMESPACE__ . '\wp_upload_dir' ) ) {
	function wp_upload_dir(): array {
		return array(
			'path'    => Stub::$upload_path,
			'basedir' => Stub::$upload_path,
		);
	}
}
