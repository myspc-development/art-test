...
class OpenAIClientTest extends WP_UnitTestCase {
    ...
    public function mock_http( $pre, $args, $url ) {
        $this->last_request = [ 'url' => $url, 'args' => $args ];
    ...
    public function test_generateTags_and_generateSummary_success(): void {
        ...
        $this->http_response = [
            'response' => [ 'code' => 200 ],
            'body'     => wp_json_encode( [ 'choices' => [ [ 'message' => [ 'content' => 'alpha, beta' ] ] ] ] ),
        ];
        ...
        $this->http_response = [
            'response' => [ 'code' => 200 ],
            'body'     => wp_json_encode( [ 'choices' => [ [ 'message' => [ 'content' => 'short summary' ] ] ] ] ),
        ];
