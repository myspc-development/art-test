...
class DashboardWidgetRegistryAliasTest extends TestCase
{
    ...
    {
        DashboardWidgetRegistry::register('widget_demo', 'Demo', '', '', [ApPlaceholderWidget::class, 'render']);
        $class = get_class(new class {
            public static function render(int $user_id = 0): string { return 'ok'; }
        });
        DashboardWidgetRegistry::bindRenderer('widget_demo', [$class, 'render']);
