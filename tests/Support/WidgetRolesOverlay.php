...
final class WidgetRolesOverlay {
    public static function register(): void {
        add_filter('ap_dashboard_widget_definitions', [self::class, 'overlay'], 1200, 1);
        add_filter('artpulse_dashboard_widget_definitions', [self::class, 'overlay'], 1200, 1);
        add_filter('ap_dashboard_widget_definitions_final', [self::class, 'overlay'], 1200, 1);
        add_filter('artpulse_dashboard_widget_definitions_final', [self::class, 'overlay'], 1200, 1);
    }
