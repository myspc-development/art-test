...
namespace {
	...
	if ( ! class_exists( 'WP_CLI' ) ) {
		class WP_CLI {
			...
			public static function set_config( array $cfg ): bool {
				self::$config = $cfg;
				return true; }
		}
	}
...
namespace WP_CLI\Utils {
	if ( ! function_exists( 'WP_CLI\\Utils\\format_items' ) ) {
		...
		class ProgressBar {
			public function tick( $n = 1 ): void {} public function finish(): void {}
		}
		function make_progress_bar( $label, $count, $interval = 1 ): ProgressBar {
