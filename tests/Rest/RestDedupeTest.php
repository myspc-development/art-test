...
class RestDedupeTest extends \WP_UnitTestCase {
	...
	public function set_up() {
		...
		// Register duplicate routes to verify automatic deduplication via the rest_endpoints filter.
		...
		// Trigger endpoint collection so the dedupe filter runs and removes duplicates.
