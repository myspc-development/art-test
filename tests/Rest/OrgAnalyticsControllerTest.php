...
class OrgAnalyticsControllerTest extends \WP_UnitTestCase
{
    ...
    {
        parent::set_up();
        $this->user_id = self::factory()->user->create(['role' => 'organization']);
        ...
        update_post_meta($this->event_id, 'event_rsvp_history', [
            '2024-01-01' => 2,
            '2024-01-02' => 3,
        ]);
    ...
    public function test_get_event_rsvp_stats(): void
    {
        ...
        $data = $res->get_data();
        $this->assertSame(['2024-01-01', '2024-01-02'], $data['dates']);
        $this->assertSame([2, 3], $data['counts']);
