...
- See the [Admin Guide](../../docs/guides/admin/admin-guide.md) for setup details.
...
- Dashboard options are explained in the [Admin Guide](../../docs/guides/admin/admin-guide.md).
...
- The [Admin Guide](../../docs/guides/admin/admin-guide.md) covers calendar configuration.

## Admin Module Walkthrough
The administration screens follow the WordPress style guide, utilizing system fonts and the default blue (#2271b1) button color. See the [Admin Guide](../../docs/guides/admin/admin-guide.md) for a full tour of the primary modules.
