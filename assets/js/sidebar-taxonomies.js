...
var SidebarTaxonomiesWithData = compose([withSelect(function (select) {
  ...
  Object.entries(taxonomiesConfig[postType] || []).forEach(function (_ref2) {
    var _ref3 = _slicedToArray(_ref2, 2),
      index = _ref3[0],
      slug = _ref3[1].slug;
    terms[slug] = select('core/editor').getEditedPostAttribute('taxonomies')[slug] || [];
    allTerms[slug] = select('core').getEntityRecords('taxonomy', slug, {
      per_page: -1
    }) || [];
  });
  return {
