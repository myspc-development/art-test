...
function WidgetConfig(_ref) {
  ...
  var _useState3 = (0, _react.useState)(config[activeRole] || widgets.map(function (w) {
    return w.id;
  }));
  ...
  function toggle(id) {
    setLayout(function (l) {
      return l.includes(id) ? l.filter(function (w) {
        return w !== id;
  ...
  return _react2['default'].createElement(
    ...
    _react2['default'].createElement(
      ...
      { value: activeRole, onChange: function (e) {
          var role = e.target.value;setActiveRole(role);setLayout(config[role] || widgets.map(function (w) {
            return w.id;
          }));
        } },
      ...
      widgets.map(function (w) {
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            'label',
            null,
            _react2['default'].createElement('input', { type: 'checkbox', checked: layout.includes(w.id), onChange: function () {
                return toggle(w.id);
              } }),
            w.name
          )
