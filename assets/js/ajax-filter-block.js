  ...
  edit: function edit(_ref) {
    ...
    useEffect(function () {
      apiFetch({
        ...
        var filtered = Object.entries(types).filter(function (_ref2) {
          var _ref3 = _slicedToArray(_ref2, 1),
            key = _ref3[0];
          return key.startsWith('ead_');
        });
        setPostTypes(filtered.map(function (_ref4) {
    ...
    useEffect(function () {
      ...
      apiFetch({
        ...
        setTaxonomies(Object.keys(type.taxonomies || {}).map(function (t) {
          return {
            label: t,
            value: t
          };
    ...
    })), /*#__PURE__*/React.createElement("p", null, "This block renders a live filter widget on the frontend."));
  },
  save: function save() {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  containers.forEach(function (container) {
    ...
    function fetchAndRender() {
      ...
      var checkedTerms = Array.from(filterDiv.querySelectorAll('input[type=checkbox]:checked')).map(function (input) {
        return input.value;
      });
