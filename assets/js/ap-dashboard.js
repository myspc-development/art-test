(function (React, ReactDOM) {
  ...
  function DashboardApp(_ref) {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, !useWpMenu && /*#__PURE__*/React.createElement(SidebarMenu, {
      role: role,
      ...
      return /*#__PURE__*/React.createElement("section", {
        ...
        "aria-labelledby": "heading-".concat(item.section),
        role: "region",
        style: {
          display: activeSection === item.section ? 'block' : 'none'
        }
      }, /*#__PURE__*/React.createElement("h3", {
        id: "heading-".concat(item.section),
        className: "screen-reader-text"
      }, item.label), item.section === 'messages' ? /*#__PURE__*/React.createElement("div", {
