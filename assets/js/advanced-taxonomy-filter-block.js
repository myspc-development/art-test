  ...
  edit: function edit(props) {
    ...
    useEffect(function () {
      apiFetch({
        ...
        var cpts = Object.entries(types).filter(function (_ref) {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(InspectorControls, null, /*#__PURE__*/React.createElement(SelectControl, {
      label: "Post Type",
      value: postType,
      options: availablePostTypes.map(function (pt) {
        return {
          label: pt,
          value: pt
        };
    ...
    }), availableTaxonomies.length > 0 && /*#__PURE__*/React.createElement(SelectControl, {
      label: "Taxonomy",
      value: taxonomy,
      options: availableTaxonomies.map(function (t) {
        return {
          label: t,
          value: t
        };
    ...
    }), terms.length > 0 && /*#__PURE__*/React.createElement(SelectControl, {
      label: "Filter by Term",
      value: selectedTerm,
      options: [{
        label: 'All',
        value: ''
      }].concat(_toConsumableArray(terms.map(function (term) {
        return {
          label: term.name,
          value: term.slug
        };
    ...
    })), loading ? /*#__PURE__*/React.createElement(Spinner, null) : /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("ul", null, posts.map(function (post) {
    ...
    }, "Prev"), /*#__PURE__*/React.createElement("span", null, " Page ", page, " of ", totalPages, " "), /*#__PURE__*/React.createElement(Button, {
