...
function ap_widget_admin_guide( int $user_id = 0, array $vars = array() ): string {
...
function ap_widget_member_guide( int $user_id = 0, array $vars = array() ): string {
...
function ap_register_guide_widgets(): void {
	DashboardWidgetRegistry::register(
		...
		array( 'roles' => array( 'administrator', 'organization' ) )
	);
